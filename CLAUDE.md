...
1. **驗證 V4.1.0 CDK4/6 整合落實** — **本版重點交付物的可用性確認**。檢查 (a) C2「三、治療指引」末尾有「CDK4/6 抑制劑（HR+/HER2- 重點藥物）」新 H3 段 (b) 該段含 3 藥對照速記表 + 9.107 條件+時序 + 9.72 條件+跨線排他 + 副作用衛教 + checklist (c) C2「四、日常追蹤重點」加 CDK4/6 一條 (d) C2「六、FAQ」多 5 個 Q (e) F2 Ki-67 行有 Grade 2+ 高 Ki-67 觀念

**等資料 / 待整合**

2. **Cancer Drug 藥物查詢系統 V4.1.0 整合進 CCM Manual drug-lookup**：Sela 上傳的 V4.1.0 含 145+ 藥物 + 139 藥物衛教資料庫 + 115/5/22 公告版資料、目前 CCM 內 drug-lookup 仍是 115/4/23——等 Sela 處理好或我整合（前面已說「另一個程式會整理好、待會作好再給」）
3. **H3 章節文字更新**：跟 drug-lookup V4.1.0 同步更新「資料截止 115/5/22」「v4.1.0」「139 藥物衛教資料庫」等

**最重要的下一步：C 系列醫師審稿**

4. **C7-C13 七個新檔請醫師團隊審閱**（V3.4.19 補的）—— 現在有 A3 醫師清單 + G2 實際成績 + C 系列重新定位 + **C2 CDK4/6 新段**可對應
5. **C3-C6 V3.4.18 已補的內容也要醫師審**
6. **C2 新 CDK4/6 段也要醫師審稿確認**（健保條件、副作用發生率等）
...
13. **電話追蹤內容三處整合（D3/F5/A1，規則 14 待套用）**

**等資料類**

14. 補 B1 各 HIS 子系統的操作截圖
15. **NGS 內容後續更新**
16. **時效性內容年度檢視**（規則 15）：每年檢視 EGFR / 五癌篩檢 / 健保藥物（含 9.107/9.72 跨線排他規則） / **G2 替換為 115 年度版**
17. 五癌篩檢推廣 QR code 2027 年改版
18. **其他癌別專屬深度教材**（若有類似 CDK4/6 這種的）— 例：HER2+ 乳癌的 T-DXd / 肺癌 EGFR-TKI 三代演進 / 大腸癌 RAS-MAPK / 攝護腺癌 ARSI 等

**雜項**

19. 美編+UI 第二輪審視
20. emoji 用法一致化（觀察 #8，工程大）
21. 再做一次 QA 試用（醫師審稿回饋整合後）

---

## 八、一句話總結

V4.1.0 **CDK4/6 抑制劑乳癌教育訓練整合到 C2**：Sela 上傳完整教材（3 藥對照 / 9.107 健保 / 9.72 健保+跨線排他 / 三藥副作用衛教 / 事前審查 checklist / 病理基礎），**個管實用化重寫**整合至 C2（新「CDK4/6 抑制劑」H3 段 + 日常追蹤加 1 條 + FAQ 加 5 個 Q）+ F2 Ki-67 行加「Grade 2+ 高 Ki-67 觀念」並 cross-ref C2。**版本號 b+1 = V4.1.0**——跟 Cancer Drug 藥物查詢系統 V4.1.0 同步好記、且乳癌深度教材是「新功能」等級。**下版第一優先**：驗證 V4.1.0 CDK4/6 整合落實 + 等 Sela 處理好 Cancer Drug V4.1.0 系統來整合 drug-lookup。
